	...
	<div class="center-area">
     ...
     %>
		<table class="container"
			...
			<tr>
				<td width="100px"><a
					href='Member_Detail.jsp?id=<%=rs.getString("id")%>'> <%=rs.getString("id")%>
				</a></td>

				<td width="100px"><%=rs.getString("ip")%></td>
				<td>
					<!-- 삭제 --> <a
					href='Member_Delete.jsp?id=<%=rs.getString("id")%>'>[삭제]</a>
				</td>

				<td><a href='MemberEdit.jsp?id=<%=rs.getString("id")%>'>[수정]</a>
